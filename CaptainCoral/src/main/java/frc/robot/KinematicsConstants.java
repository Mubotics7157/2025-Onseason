...
public class KinematicsConstants { //FINAL KEYWORD???
    ...
    public static final double Drivetrain_Speed_Multiplier = 0.6;
    ...
    public static final double End_Effector_Wrist_Zero_Setpoint = 0.573; //01171875
    ...
    public static final double End_Effector_Wrist_Algae_Remove_Setpoint = 12.0;
    ...
    public static final double Elevator_L4_Setpoint = 24.5;
