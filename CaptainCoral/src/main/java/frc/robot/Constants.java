...
public class Constants { //FINAL KEYWORD???
    //====================General====================
    ...
    //Intake Setpoints
    public static final double Intake_Zero_Setpoint = 4.92;
    public static final double Intake_Ground_Deploy_Setpoint = 16.927;
    ...
    public static final double End_Effector_Wrist_Velocity = 16.0;
    public static final double End_Effector_Wrist_Acceleration = 32.0;
    ...
    public static final double End_Effector_Ground_Intake_Speed = 0.71;
